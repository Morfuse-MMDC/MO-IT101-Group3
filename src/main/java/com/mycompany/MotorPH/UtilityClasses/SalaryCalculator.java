...
import com.mycompany.MotorPH.Attendance;
...
public class SalaryCalculator {
    ...
    public static long[] getAttendance(JsonArray json, String ENKey, String employeeNumber, int numberOfElements, Month currentMonth){
    ...
    public static String getAttendance(JsonObject json, Month currentMonth, AtomicInteger presentsNum, AtomicInteger latesNum, AtomicInteger absentsNum, AtomicInteger hoursRenderedNum){
        long attendance = 0;
    ...
    private static void getAttendanceResult(int i, String ENKey, String employeeNumber, JsonArray json, Month currentMonth, long[] attendance, AtomicInteger index){
        if (json.get(i).getAsJsonObject().get(ENKey).getAsString().equals(employeeNumber)) {
    ...
    public static double getSSS(double salary){
        double[] compensationRanges = {
            3250, 3750, 4250, 4750, 5250, 5750, 6250, 6750, 7250, 7750, 8250, 8750, 9250, 9750, 10250,
            10750, 11250, 11750, 12250, 12750, 13250, 13750, 14250, 14750, 15250, 15750, 16250, 
            16750, 17250, 17750, 18250, 18750, 19250, 19750, 20250, 20750, 21250, 21750, 22250, 
            22750, 23250, 23750, 24250, 24750, Double.MAX_VALUE
        };
